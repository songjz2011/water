...
public class TrainsRouteNumberMaxStopServiceTest {
    ...
    @Test
    public void empty_param_should_have_zero_numer() {
    ...
    @Test
    public void empty_trainstationlist_should_have_zero_numer() {
    ...
    @Test
    public void inexistence_trainstation_should_have_zero_numer() {
        int actualValue = service.getTripsNumber("INEXISTENCETRAIN", "C", 3);
        assertEquals(0, actualValue);
    }

    @Test
    public void inexistence_route_should_have_zero_numer() {
        int actualValue = service.getTripsNumber("A", "C", 1);
        assertEquals(0, actualValue);
    }

    @Test
    public void existence_route_should_have_more_than_zero_numer() {

/*
 * LoadAnalyzeHttpConnectRequest.java
...
/**
 * <pre>
 * 负荷分析 - http协议 - 连接服务器端的请求
 * </pre>
 * 
 * @author songjz
 * @time 2013年12月18日
 */
public class LoadAnalyzeHttpConnectRequest extends HttpConnectRequest {
	...
	public <T> T search(ServerSearch<T> search, Context context) throws SearchException {
		...
		pairList.add(new BasicNameValuePair("command", "LoadAnalyze"));

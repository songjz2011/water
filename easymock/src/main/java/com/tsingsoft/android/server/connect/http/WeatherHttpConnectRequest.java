/*
 * WeatherHttpConnectRequest.java
...
/**
 * <pre>
 * 天气数据 - http协议 - 连接服务器端的请求
 * </pre>
 * 
 * @author songjz
 * @time 2013年12月19日
 */
public class WeatherHttpConnectRequest extends HttpConnectRequest {
	...
	public <T> T search(ServerSearch<T> search, Context context) throws SearchException {
		...
		pairList.add(new BasicNameValuePair("command", "Weather"));
